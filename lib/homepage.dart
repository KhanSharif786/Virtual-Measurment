import 'package:body_measurment/vmlist.dart';
import 'package:flutter/material.dart';
import 'package:body_measurment/detail.dart';

// ... make sure you import the necessary packages and files ...
...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
  ...
  int _currentIndex = 0; // to keep track of the currently selected index
  ...
  void _onItemTapped(int index) {
    if (index == 2) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => VmListPage()), // assuming you have VmListPage defined elsewhere
      );
    } else {
      setState(() {
        _currentIndex = index;
